...
namespace FileManagementAPI.Service.Models
{
    public partial class OpsDtbtransportRequestOrderItemRoute
    {
        ...
        public bool? IsAllowanceWithoutElevator { get; set; }
        public decimal? Volume { get; set; }
        public decimal? ReturnedCodvalue { get; set; }
        public string CheckedCoduser { get; set; }
        public DateTime? CheckedCoddateTime { get; set; }
        public string CheckedCodnote { get; set; }
    }
}
